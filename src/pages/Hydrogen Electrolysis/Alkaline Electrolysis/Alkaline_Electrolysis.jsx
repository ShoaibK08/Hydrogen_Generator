      ...
      <div className="w-[95%] max-w-[90%] space-y-[30px] mx-auto py-[30px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="flex-col flex items-start space-y-3.5 lg:space-y-[26px] justify-center">
            ...
            Alkaline electrolysis (AEL) is a process used to produce hydrogen gas by splitting water into hydrogen and oxygen using electricity. In AEL, water is mixed with an alkaline solution, usually potassium hydroxide (KOH) or sodium hydroxide (NaOH), which acts as the electrolyte. When electrical current is passed through this solution, water molecules are broken down at the electrodes: hydrogen gas forms at the cathode (negative electrode), while oxygen gas forms at the anode (positive electrode). This method is efficient and commonly used for generating hydrogen in various industrial applications. </p>
            <button 
